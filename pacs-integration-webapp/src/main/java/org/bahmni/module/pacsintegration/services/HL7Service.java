...
import org.bahmni.module.pacsintegration.atomfeed.mappers.hl7.impl.PatientIdentificationMapperImpl;
...
public class HL7Service {
    ...
    logger.error("=== ENTERING addPatientDetails - THIS IS A TEST ==="); 
